...
export const routePermissions: Record<string, UserRole[]> = {
  ...
  [DASHBOARD_ROUTE_PATHS.students]: [UserRole.SUPER_ADMIN, UserRole.TUTOR, UserRole.VOLUNTEER],
  [DASHBOARD_ROUTE_PATHS.cohorts]: [UserRole.SUPER_ADMIN, UserRole.TUTOR],
  [DASHBOARD_ROUTE_PATHS.baselineAssessments]: [UserRole.SUPER_ADMIN, UserRole.TUTOR, UserRole.VOLUNTEER],
  [DASHBOARD_ROUTE_PATHS.studentReports]: [UserRole.SUPER_ADMIN, UserRole.TUTOR],
  [DASHBOARD_ROUTE_PATHS.attendanceManagement]: [UserRole.SUPER_ADMIN, UserRole.TUTOR],
